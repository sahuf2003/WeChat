...
const Image = styled.div`
  ...
  border-radius: 1rem;
background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnWF7tuovrZt1EMe2oV7V7DrI8DGO5lwClOw&s);
`;
...
export function Women({ height = 400, width = 300 }) {
  const ref = useRef();
