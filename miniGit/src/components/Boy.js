...
const Image = styled.div`
  ...
  border-radius: 1rem;
  background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRRk7VS7Dbpb8kgz4v9eFKI8JwPGuFhCXF-tQ&s);
`;
...
export function Boy({ height = 400, width = 300 }) {
  const ref = useRef();
